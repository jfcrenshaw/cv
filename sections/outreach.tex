\section{Outreach}
\begin{itemize}
    \item Astronomy on Tap, San Francisco Co-organizer \hfill \textit{San Francisco, CA}; 2025 -- present
    % Co-organize monthly public talks on astronomy and astrophysics at a local bar; duties include recruiting speakers, advertising events, and hosting.

    \item Lectures on Tap: \textit{Mapping the Dark Universe with Rubin} \hfill \textit{San Francisco, CA}; May \& Aug 2026
    % Public talk introducing how the Rubin Observatory will use stellar streams and large-scale structure to answer questions about dark matter and dark energy

    \item Public lecture at the De Anza College Planetarium: \textit{The Rubin Observatory} \hfill \textit{Cupertino, CA}; Apr 2026
    % Public talk, including full-dome visuals, introducing how the Rubin Observatory will use stellar streams and large-scale structure to answer questions about dark matter and dark energy
